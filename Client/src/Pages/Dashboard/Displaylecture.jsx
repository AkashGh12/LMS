...
function Displaylecture() {
    ...
    async function onLectureDelete(courseId, lectureId) {
        try {
            ...
            await dispatch(getCourseLectures(courseId));
            console.log("Course lectures fetched successfully");
        } catch (error) {
            console.error("Error in onLectureDelete:", error);
    ...
    return (
        <HomeLayout>
            <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-wihte mx-[5%] text-white">
