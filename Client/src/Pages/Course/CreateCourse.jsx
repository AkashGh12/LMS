    ...
    return (
        <HomeLayout>
            <div className='flex items-center justify-center h-[100vh]'>
                ...
                className='flex flex-col justify-center gap-5 rounded-lg p-4 text-white w-[700px] my-10 shadow-[0_0_10px_black] relative'>
                    ...
                    <main className='grid grid-cols-2 gap-x-10'>
                        ...
                        <div className='flex flex-col gap-1'>
                                <label
                                className='text-lg font-semibold' 
                                htmlFor="title"> Course Instructor
                                </label> 
                                <input
                                required
                                type='text'
                            ...
                            <div className='flex flex-col gap-1'>
                                <label
                                className='text-lg font-semibold' 
                                htmlFor="title"> Course Description
                                </label> 
                                <textarea
                                required
                                type='text'
                ...
                <button className=" bg-transparent p-2 rounded-sm hover:bg-slate-700 border border-[#FF6A3D] mt-2 transition-all ease-in-out"
                type="submit">
                    Create Course
                </button>
                </form>
